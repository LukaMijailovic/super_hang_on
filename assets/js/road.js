class Road {
  ...
  static reset() {
    ...
    Road.addCurve(ROAD.LENGTH.SMALL, ROAD.CURVE.HARD, ROAD.HILL.LOW);
    Road.addStraight(ROAD.LENGTH.SHORT);
    Road.addSCurves();
    Road.addCurve(ROAD.LENGTH.SMALL, ROAD.CURVE.HARD, ROAD.HILL.NONE);
    Road.addStraight(ROAD.LENGTH.MEDIUM);
    Road.addCurve(ROAD.LENGTH.SHORT, ROAD.CURVE.HARD, ROAD.HILL.NONE);
    Road.addCurve(ROAD.LENGTH.LONG, -ROAD.CURVE.EASY, ROAD.HILL.NONE);
    Road.addCurve(ROAD.LENGTH.LONG, -ROAD.CURVE.EASY, ROAD.HILL.NONE);
    Road.addCurve(ROAD.LENGTH.MEDIUM, ROAD.CURVE.EASY, ROAD.HILL.MEDIUM);
    Road.addCurve(ROAD.LENGTH.MEDIUM, ROAD.CURVE.HARD, ROAD.HILL.MEDIUM);
    Road.addStraight(ROAD.LENGTH.SHORT);
    Road.addCurve(ROAD.LENGTH.MEDIUM, ROAD.CURVE.HARD, ROAD.HILL.LOW);
